  ...
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-md-6 bold">
          <h5 class="card-title mb-2">gem Details</h5>
        </div>
      ...
      <table class="table text-center table-info mt-4" id="storegemBook">
        <thead>
          <tr>
            <th scope="col">#</th>
        ...
        <tbody>
          <tr v-for="gem in gem_details.data" :key="gem.id">
    ...
    <div class="card-footer">
      <pagination
        ...
        :limit="3"
        align="right"
        @pagination-change-page="get_gem_details"
      ></pagination>
    </div>
    ...
    >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <gem-details-view> </gem-details-view>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    view_gem(gem) {
      bus.$emit("gem-details", gem);
    },

    get_gem_details(page = 1) {
      axios
        .get("office-GemConsigneedata?page=" + page, {
          params: {
        ...
        .then((response) => {
          this.gem_details = response.data;

          //     $(document).ready(function () {
          //   $("#storegemBook").DataTable({
          //     dom: "Bfrtip",
          //     buttons: ["copy", "csv", "excel", "pdf", "print"],
          //   });
          // });

          setTimeout(() => (this.gem_details = response.data));
        });
    },
  },
};
