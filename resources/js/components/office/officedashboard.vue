<template>
  <div class="card">
    <div class="card-body">
      <div class="row mb-5">
        <div class="col-md-6 bold">
          <h5 class="card-title mb-2">Arrival Register</h5>
        </div>
          ...
          <tr v-for="arrival in arrival_details.data" :key="arrival.id">
            ...
            <td>
              <button
                ...
                data-toggle="modal"
                data-target=".officeDashboardView"
    ...
    <div
      class="modal fade officeDashboardView"
      tabindex="-1"
      role="dialog"
...
export default {
  ...
  methods: {
    ...
    get_Arrival_details(page = 1) {
      axios
        .get("office-dashboard-arrivaldata?page=" + page, {
          params: {
